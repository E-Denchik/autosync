"""Плановая (Celery beat) подтяжка своих цен/продаж и рыночных данных,
формирование PriceSnapshot и предложения LLM по цене/карточке.
...
def sync_ozon_prices():
    ...
    try:
        ...
        stats_resp = ozon.get_sales_stats(str(date_from), str(date_to))
